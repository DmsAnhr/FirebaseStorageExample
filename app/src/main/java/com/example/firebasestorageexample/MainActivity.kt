...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bt_choose_image.setOnClickListener { launchGallery() }
        bt_upload_image.setOnClickListener { uploadImage() }
        bt_show_image.setOnClickListener{
    ...
    private fun launchGallery(){
        ...
        startActivityForResult(Intent.createChooser(i,"Seleect Picture"), PICK_IMAGE_REQUEST)
    }
